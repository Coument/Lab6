...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] cubeNameArray = new String[]{"哭哭","發抖","再見","生氣","昏倒","竊笑","很棒","你好","驚嚇","大笑"};
        ...
        String[] mes=new String[]{"訊息1","訊息2","訊息3","訊息4","訊息5","訊息6"};
        ArrayAdapter<String> mesAdpter= new ArrayAdapter<>(this, android.R.layout.simple_list_item_1,mes);
        ListView listView=findViewById(R.id.listview);
        listView.setAdapter(mesAdpter);
